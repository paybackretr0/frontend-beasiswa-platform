...
const EditStepThree = ({
  ...
  useEffect(() => {
    ...
    setSelectedStudyPrograms(initialData.study_programs || []);
  ...
  // Handle Faculty Selection dengan otomatis select departemen
  ...
  // Handle Department Selection dengan otomatis select program studi
  ...
  const handleSubmit = () => {
    // Validasi khusus untuk website_url jika eksternal
    ...
    // Validasi umum untuk semua field lainnya
    if (
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      {/* Info untuk beasiswa eksternal */}
      {isExternal && (
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <h3 className="font-medium text-blue-800 mb-2">Beasiswa Eksternal</h3>
          <p className="text-sm text-blue-700">
            Untuk beasiswa eksternal, website URL wajib diisi. Field lainnya
            tetap sama seperti beasiswa internal.
          </p>
        </div>
      )}
      ...
      {/* Website URL dengan validasi khusus untuk eksternal */}
      <div className="mb-6">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Website Penyedia{" "}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          {studyProgram.degree} {studyProgram.code}
                        </div>
                        <div className="text-xs text-gray-500 leading-tight">
                          {studyProgram.department?.name}
                        </div>
                        <div className="text-xs text-gray-400 leading-tight">
                          {studyProgram.department?.faculty?.name}
                          {!canUnselect &&
                            selectedStudyPrograms.includes(studyProgram.id) && (
