...
import { Empty, Spin, Tag, Divider } from "antd";
import {
  HomeOutlined,
  ReloadOutlined,
  FileSearchOutlined,
...
const DetailInformation = () => {
  ...
  const loadInformationDetail = async () => {
    try {
      ...
      setInformation(data);
      document.title = `${data.title} - Informasi`;
    } catch (error) {
      setError(error.message || "Gagal memuat detail informasi");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                <h1 className="text-4xl font-bold mb-4">{information.title}</h1>
